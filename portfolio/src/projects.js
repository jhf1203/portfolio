...
const projects= [

            {
                id: 4,
                name: "Bookmarked",
                projectLinks: [{type: "Repository",
                    url: "https://github.com/jhf1203/Project-2"}, 
                    {type: "Deployment",
                        url: "https://project-2-team-2.herokuapp.com/"}],
                skillsUsed: "Sequelize, Express, Handlebars, Passport (NPM), jQuery, CSS, 3rd Party APIs, Travis, Linting.",
                demoThumbnail: [bookmarkedImg],
                demoContent: [bookmarkedGif],
                demoType: "gif",
                summary: "This was our second group project for the class, and tasked us with creating a full-stack application of our choosing given certain conditions. We were required to serve a MySql database through Heroku, using the Sequelize ORM, and our HTML content was required to be rendered with Handlebars for Express.",
            ...
            },
            {
                ...
                projectLinks: [{
                    ...
                    {type: "Deployment",
                    url: "https://stormy-taiga-92457.herokuapp.com/"
                }],
                skillsUsed: "Express, MySql, Node.js, Express Handlebars",
                demoThumbnail: [burgerImg],
                demoContent: [BurgerGif],
                demoType: "gif",
                summary: "This assignment required me to create an app that allows the user to name a burger, and then 'devour' it at the click of a button. The burger information is stored in a database powered by mySql, and is hosted through heroku.",
                details: "This is the closest thing to a full-stack assignment that I've completed so far, in that the front end can be manipulated by the user via code on the back end and values that are housed in a database. There are multiple API calls on this app, as well as the usage of ORMs and handlebars for templating."
            },
            {
                id: 2,
                ...
                skillsUsed: "MySQL, Node.js, Express, Templating (no engines), Object classes & subclasses.",
                demoThumbnail: [teamProfileImg],
                demoContent: ["'https://www.youtube.com/embed/U77DcU5zm8g'"],
                demoType: "iframe",
                summary: "A scalable command-line application that displays basic info for various employees within an organization, by employee type.",
                details: "This was my first experience bringing back-end code to the front in a styled form using templating. No template libraries or packages were used for this project, everything was rendered through Javascript and Express. Additionally this project featured extensive usage of express modules, and classes and subclasses in Javascript to define the types of unique employees that belong to this particular organization. Additionally we were given free reign with the styling, and you will notice my finished product is quite different than the example file shown in the assets folder."
            },
            {
                id: 1,
                ...
                skillsUsed: "JavaScript (jQuery), Server-Side APIs (Google Places, The Movie Database, Open Movie Database), More involved GitHub usage (branching & forking), Working on a team with multiple collaborators, Public speaking/presentation.",

                ...
                <section className="row bottom-row">
                    <div className="col-md-8 section-row">
                        <div className="row contact-list">
                            ...
                            <i className="fa fa-github right-icon"></i>
                        </div>
                        <div className="row contact-list">
                            <a className="link-city" href="https://www.visitraleigh.com/events/" target="_blank">
                                Raleigh, NC, USA</a>
                            <a className="link-email" href="mailto:jhf1203@gmail.com">E-mail</a>
                            <a className="link-phone" href="#" target="_blank">252.917.1571</a>
                            <a className="link-linkedin" href="https://www.linkedin.com/in/jim-faulkner-13476534" target="_blank">LinkedIn</a>
